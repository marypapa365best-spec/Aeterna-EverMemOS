...
- **9️⃣ 回忆录（Memoir）**
  用可视化方式系统整理人生中最重要的三类记录，数据仅存于本机浏览器，完全私密：
  - **血缘关系网**：以家族树形式记录和梳理直系亲属、旁系亲属与配偶关系；节点可自由拖拽排布，支持上传头像、填写生辰与备注，通过搜索快速定位成员；
  - **社会关系网**：以「本人」为中心，可视化呈现社交圈中的重要人物及其与自己的关系，帮助整理和留存人生中的重要他人；
  - **人生足迹**：以时间轴方式记录人生各阶段的关键地点与事件，为数字分身补充人生经历的时间维度。
